function HomePage() {
  return (
    <div className="flex flex-col gap-16">
      <h1 className="font-bebas text-sm sm:text-2xl 2xl:text-4xl 2xl:p-4 tracking-wide text-center p-2 w-2/3 bg-primary-light mx-auto rounded-lg mt-4">
      ...
      <p className="font-chewy text-lg sm:text-2xl 2xl:text-4xl text-center text-accent-red-dark sm:w-1/3 w-2/3 mx-auto mt-6">
